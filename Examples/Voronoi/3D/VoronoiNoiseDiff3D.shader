Shader "Unity-Noises/VoronoiNoiseDiff3D/Update"
{
	Properties
	{
...
#include "../../../Includes/VoronoiNoise3D.hlsl"
	...
	half4 frag(v2f_customrendertexture i) : SV_Target
	{
		...
		output += VoronoiNoiseDiff_Octaves(float3(uv,0), _Scale, _Speed.xyz, int(_Octave), _OctaveScale, _Attenuation, _Jitter, time);

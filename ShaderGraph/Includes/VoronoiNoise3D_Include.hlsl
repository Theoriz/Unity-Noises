#ifndef VORONOINOISE3D_INCLUDED
#define VORONOINOISE3D_INCLUDED
...
void VoronoiNoiseOctaves_float(float3 inCoord, float scale, int octaveNumber, float octaveScale, float octaveAttenuation, float jitter, out float Out)
{
	float freq = scale;
	float weight = 1.0f;
	Out = 0;	
